...
docker build . -t raccoon_pirate_rpi_build
	
# Build raccoon-pirate
RPI_TOOLCHAIN="/home/develop/opt/x-tools/${TARGET_TRIPLET}/bin/${TARGET_TRIPLET}"
BUILD_CMD="cd /home/develop/RaccoonPirate && CGO_ENABLED=1 GOARCH=arm64 CC=${RPI_TOOLCHAIN}-gcc CXX=${RPI_TOOLCHAIN}-g++ sudo go build -ldflags '${LDFLAGS}' -o /home/develop/build/${BINARY_NAME} ${SOURCE_MAIN} && sudo chown develop:develop /home/develop/build/${BINARY_NAME}"
